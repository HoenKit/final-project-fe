...
{
    public class ReportWorkshopModel : PageModel
    {
        private readonly ILogger<ReportWorkshopModel> _logger;
        private readonly ApiSettings _apiSettings;
        private readonly HttpClient _httpClient;

        public ReportWorkshopModel(ILogger<ReportWorkshopModel> logger, IOptions<ApiSettings> apiSettings, HttpClient httpClient)
        {
            _logger = logger;
        ...
        [BindProperty]
        public ReportWorkShopDto ReportWorkShop { get; set; } = new();
        public string CurrentUserId { get; set; }
        public string BaseUrl { get; set; }

        public async Task<IActionResult> OnPostAsync(int WorkShopId, string Content)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    ReportWorkShop = new ReportWorkShopDto
                    {
                    ...
                    var content = new StringContent(JsonSerializer.Serialize(ReportWorkShop), System.Text.Encoding.UTF8, "application/json");

                    string notiApiUrl = $"{BaseUrl}/ReportWorkShop";
