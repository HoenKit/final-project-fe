...
{
    public class ListPendingModel : PageModel
    {
        private readonly ILogger<ListPendingModel> _logger;
        private readonly ApiSettings _apiSettings;
        private readonly HttpClient _httpClient;

        public ListPendingModel(ILogger<ListPendingModel> logger, IOptions<ApiSettings> apiSettings, HttpClient httpClient)
        {
            _logger = logger;
