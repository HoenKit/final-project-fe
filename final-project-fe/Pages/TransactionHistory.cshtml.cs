...
namespace final_project_fe.Pages
{
    ...
    {
        private readonly ILogger<TransactionHistoryModel> _logger;
        private readonly ApiSettings _apiSettings;
        private readonly HttpClient _httpClient;

        public TransactionHistoryModel(ILogger<TransactionHistoryModel> logger, IOptions<ApiSettings> apiSettings, HttpClient httpClient)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> OnGetFilterTransactionsAsync(string? status = null)
        {
            try
            {
                if (!Request.Cookies.ContainsKey("AccessToken"))
